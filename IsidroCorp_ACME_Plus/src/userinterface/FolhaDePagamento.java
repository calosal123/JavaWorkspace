...
//		}
		...
		lista.add(new Chefe(1,"Jose Almeida", 3500f, 15f, 850f));
		lista.add(new Empreiteiro(2, "Ana Pires", 5000f));
		lista.add(new Comissionado(3, "Carlos Santos", 2500f, 27.5f));
		lista.add(new Horista(4, "Paula Torres", 85.0f, 70));
		lista.add(new Horista(5, "Roberto Nunes", 78.50f, 112));
		lista.add(new Comissionado(6, "Monica Silvestre", 2750f, 18f));
		lista.add(new Comissionado(7, "Pedro Albuquerque", 1950f, 35f));
		lista.add(new Administrativo(8, "Joao Maldonado", 4000f, 400f, 650f));
		lista.add(new Administrativo(9, "Marcelo Moreira", 3700f, 350f, 650f));
		lista.add(new Comissionado(10, "Felipe Cunha", 2000f, 22f));
		
		lista.remove(6);  // além de remover, reorganiza a lista para que os elementos seguintes sejam recuados
